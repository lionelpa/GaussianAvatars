...
def save_tensor_as_image(tensor, cam, iteration, training_start_time, output_dir="output/cam_renders"):
    """
    ...
    out_dir = os.path.join(parent_dir, output_dir, current_time)
