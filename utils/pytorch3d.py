...
def mesh_laplacian_smoothing_per_vertex(meshes, method: str = "uniform"):
    r"""
    ...
    # loss = loss.norm(dim=1)  # gets norm of lap per vertex
    # loss = loss * weights    # weights are 1/nverts
    # return loss.sum() / N #original return

    return loss # per vertex lap vector
